...
module.exports.onlyGetSentences = (text) => {
...
module.exports.splitContentToSentences = splitContentToSentences;

module.exports.splitContentToParagraphs = (content, callback) => {
...
module.exports.sentencesIntersection = sentencesIntersection;
...
module.exports.getBestSentence = (paragraph, sentences_dict, callback) => {
...
module.exports.getSortedSentences = (paragraph, sentences_dict, n, callback) => {
    splitContentToSentences(paragraph, (sentences) => {
...
module.exports.getSentencesRanks = (content, callback, sentences_dict) => {
