...
module.exports.summarizeFromUrl = function(url, callback) {
...
module.exports.summarize = (title, content, callback, sentences_dict) => {
...
module.exports.getSortedSentences = (content, n, callback, sentences_dict) => {
